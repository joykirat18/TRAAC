...
def curate_bbeh_question_dataset():
    import json
    with open('scripts/data/bbeh/data.json', 'r') as f:
        data = json.load(f)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="./bbeh_test_dataset")
    parser.add_argument("--hdfs_dir", default=None)

    args = parser.parse_args()

    bbeh_question_dataset = curate_bbeh_question_dataset()
    # mip_insufficient_dataset = curate_mip_insufficient_dataset()


    dataset = datasets.concatenate_datasets([bbeh_question_dataset])
